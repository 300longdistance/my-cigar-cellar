  ...
  const hasAnyPairingData =
    ...
    <main className="pairings-phone-readable pairings-ipad-readable min-h-screen overflow-x-hidden bg-black text-white">
      <div className="mx-auto w-full max-w-[1500px] px-1.5 py-1.5 sm:px-4 sm:py-4 lg:px-5 lg:py-5">
        <div className="grid min-h-[calc(100vh-12px)] grid-cols-1 gap-2 md:grid-cols-[360px_minmax(0,1fr)] md:gap-4 lg:grid-cols-[410px_minmax(0,1fr)]">
          <aside className="rounded-[24px] bg-[#050505] px-3 py-3 sm:px-4 sm:py-4">
            <div className="mb-3 flex items-center justify-between">
              ...
              <div className="text-center">
                ...
                <h1 className="mt-1 text-[16px] text-white sm:text-[18px]">
            ...
            {!hasAnyPairingData ? (
              <div className="rounded-[22px] bg-[linear-gradient(135deg,#0d0d0f_0%,#17181c_55%,#111111_100%)] px-4 py-5 text-center">
                <div className="mx-auto flex h-12 w-12 items-center justify-center rounded-full border border-[#3a2a0f] bg-[#121316] text-[22px] text-[#d58a24]">
                  ★
                </div>
                ...
                <p className="mt-2 text-[13px] leading-relaxed text-white/55">
                  Log cigars with coffee, bourbon, rum, food, or other pairings
                  to build pairing recommendations.
                </p>
          ...
          <section className="rounded-[24px] border border-[#171717] bg-[radial-gradient(circle_at_top,#141414_0%,#050505_48%,#000000_100%)] px-4 py-5 sm:px-5 sm:py-6">
            {!hasAnyPairingData ? (
              <div className="mx-auto flex min-h-[420px] max-w-[760px] flex-col items-center justify-center rounded-[22px] border border-[#3a2a0f] bg-[linear-gradient(180deg,#111214_0%,#0c0c0d_100%)] px-5 py-10 text-center">
                <div className="text-[10px] uppercase tracking-[0.14em] text-[#c8821f]">
                  Pairing Intelligence
                </div>

                <h2 className="mt-2 text-[24px] text-white">
                  Start logging pairings
                </h2>

                <p className="mx-auto mt-3 max-w-[460px] text-[14px] leading-relaxed text-white/55">
                  Once pairings are saved in your smoke logs, this page will
                  show the strongest cigar and pairing matches based on your
                  own ratings.
                </p>
              </div>
            ) : (
